...
- Renamed `ref` to `fromRef` in order to let React assign correctly the value
...
[unreleased]: https://github.com/neolution-ch/react-hook-form-components/compare/2.2.0...HEAD
